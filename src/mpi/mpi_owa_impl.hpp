 ...
 */
#ifndef MPI_OWA_IMPL_HPP
#define MPI_OWA_IMPL_HPP
...
inline MPIOWA::MPIOWA(const std::string& trainBaseFilename,
...
inline double MPIOWA::TrainAccuracy()
{
...
inline double MPIOWA::TestAccuracy()
{
  // Compute accuracy on local system.
...
inline size_t MPIOWA::CountCorrect(const arma::sp_mat& data,
...
inline void MPIOWA::DistributeModel()
{
